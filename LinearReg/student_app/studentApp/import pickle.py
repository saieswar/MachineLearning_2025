...
def main():
    ...
    if st.button('Predict your Score'):
        ...
        st.write(prediction)
        st.write(f"Based on your input, your predicted performance score is: {prediction}")
